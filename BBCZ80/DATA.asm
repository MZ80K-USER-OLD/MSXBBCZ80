...
FILE_COUNTS:	DEFS	2		; 累積読み込みバイト数
FILE_MAXSIZE:	DEFS	2		; 最大読み込みバイト数
SEEK_PREV_L:    DEFS    2       ; 読み込み前ポインタ下位16bit
SEEK_PREV_H:    DEFS    2       ; 読み込み前ポインタ上位16bit
SEEK_CUR_L:     DEFS    2       ; 読み込み後ポインタ下位16bit
SEEK_CUR_H:     DEFS    2       ; 読み込み後ポインタ上位16bit
