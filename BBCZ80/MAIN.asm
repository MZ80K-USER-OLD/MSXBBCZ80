...
;
	CALL INITTXT
;
;  COPY RIGHT MESSAGE TO OUTPUT
;	
	LD  HL,  STARTMSG
	CALL	TELL
;
;   MSX DOS Version CHeck
	CALL  CheckMSXDOS
#ENDIF
;
;	STACK INITIALiSATION AND DISPLAY HIMEM
	LD (HIMEM),SP
	LD HL,STACKMSG
	CALL STRPUT
	LD  HL,SP 
...
;NEW
;
BAD:	LD HL,BADPROGRAMMSG
CALL	TELL		;"Bad program'
...
NOTICE:	DEFM	"(C) Copyright R.T.Russell 2025"
	DEFB	CR
	DEFB	LF
NOTICE2:	DEFM "Modified for MSX2 by MZ80K-USER-OLD 2026"
	DEFB	CR
	DEFB	LF
	DEFB	0
STACKMSG:
	DEFB 	"STACK TOP ADDRESS: "
	DEFB	 0
	;END	START
