...
;
INIT0:	JP	INIT	;INITIALISE HARDWARE
...
WIDTH:		DEFB	80		;WIDTH
CURUP:		DEFB	'G' & 1FH	;CURSOR UP
CURDOWN:	DEFB	'O' & 1FH	;CURSOR DOWN
CURHOME:	DEFB	'F' & 1FH	;START OF LINE
CUREND:		DEFB	'N' & 1FH	;END OF LINE
DELLINE:	DEFB	'X' & 1FH	;DELETE TO END OF LINE
BACKSP:		DEFB	08H		;BACKSPACE & DELETE
DELTOST:	DEFB	'U' & 1FH	;DEL TO START OF LINE
CURLEFT:	DEFB	'J' & 1FH	;CURSOR LEFT
CURRIGHT:	DEFB	'L' & 1FH	;CURSOR RIGHT
DELCHR:		DEFB	'R' & 1FH	;DELETE CHARACTER
INSCHR:		DEFB	'Q' & 1FH	;INS/OVR TOGGLE
;
FIN:	;END
